...
ade20k_classes = ['wall', 'building', 'sky', 'floor', 'tree', 'ceiling', 'road', 'bed ', 'windowpane', 'grass',
                  ...
                  'column', 'signboard', 'chest of drawers', 'counter', 'sand', 'sink', 'skyscraper', 'fireplace',
                  'refrigerator', 'grandstand', 'path', 'stairs', 'runway', 'case', 'pool table', 'pillow',
                  'screen door', 'stairway', 'river', 'bridge', 'bookcase', 'blind', 'coffee table', 'toilet', 'flower',
                  'book', 'hill', 'bench', 'countertop', 'stove', 'palm', 'kitchen island', 'computer', 'swivel chair',
                  'boat', 'bar', 'arcade machine', 'hovel', 'bus', 'towel', 'light', 'truck', 'tower', 'chandelier',
                  'awning', 'streetlight', 'booth', 'television receiver', 'airplane', 'dirt track', 'apparel', 'pole',
                  'land', 'bannister', 'escalator', 'ottoman', 'bottle', 'buffet', 'poster', 'stage', 'van', 'ship',
...
prompt_templates = ['a bad photo of a {}.', 'a photo of many {}.', 'a sculpture of a {}.',
                    ...
                    'a good photo of the {}.', 'a rendering of the {}.', 'a {} in a video game.', 'a photo of one {}.',
                    ...
                    'a low resolution photo of a {}.', 'the toy {}.', 'a rendition of the {}.',
                    'a photo of the clean {}.', 'a photo of a large {}.', 'a rendition of a {}.',
                    ...
                    'a photo of a small {}.', 'a tattoo of the {}.', 'there is a {} in the scene.',
                    'there is the {} in the scene.', 'this is a {} in the scene.', 'this is the {} in the scene.',
                    'this is one {} in the scene.', ]


def parse_args():
    parser = argparse.ArgumentParser(description='Prompt engineering script')
    ...
    parser.add_argument('--class-set', default=['stuff'], nargs='+',
                        choices=['city', 'ade', 'stuff', 'voc', 'context', 'acontext', 'mickey', 'batman', 'mario',
                                 'gates', 'blur', 'sports', 'car_brands', 'batman_ext', 'car_color'],
...
if __name__ == '__main__':
    ...
    classes = []
    all_set_name = ''
    name_mapping = {'city': cityscapes_classes, 'ade': ade20k_classes, 'stuff': coco_stuff_classes, 'voc': voc_classes,
                    'context': pascal_context_classes, 'coco': coco_stuff_classes_27}
